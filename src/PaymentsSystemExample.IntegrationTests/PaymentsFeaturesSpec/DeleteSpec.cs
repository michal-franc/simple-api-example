...
{
    [FeatureDescription(
        @"As a user when I call Payment API to DELETE payment"
    )]
    [Label("Payment API DELETE")]
    public class DeleteSpec : PaymentApiBaseFeatureFixture
    {
        [Scenario]
        [MultiAssert]
        ...
        public async Task PaymentDoesExistTest()
        {
            ...
            await Runner.RunScenarioAsync(
               ...
               _ => I_call_api_delete_with(paymentId),
        ...
        {
            await Runner.RunScenarioAsync(
               _ => I_call_api_delete_with("incorrect_id"),
